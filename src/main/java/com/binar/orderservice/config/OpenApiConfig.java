package com.binar.orderservice.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenApi(){
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("Order Service API for Ticketing")
                        .version("1.0.0")
                        .contact(
                                new Contact()
    ...
    private List<Server> servers() {
        ...
        serverDev.setUrl("http://localhost:8078/");
        serverDev.setDescription("Main server for Dev");

        Server serverProd = new Server();
        serverProd.setUrl("https://api-mticket-order-service.up.railway.app/");
